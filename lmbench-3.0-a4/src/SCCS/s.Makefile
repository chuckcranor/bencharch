H29637
s 00060/00000/00426
d D 1.84 04/05/19 17:46:30 staelin 85 84
c Add dependencies for assembly files too.
cC
cK13551
e
s 00025/00003/00401
d D 1.83 04/05/09 13:14:43 staelin 84 83
c Add a Makefile target to generate assembly files to make it easier
c to verify the assembly code generated for each benchmark.  Use
c "make assembler" to create all the .s files.
cC
...
e
s 00014/00027/00390
d D 1.82 03/03/10 10:27:51 staelin 83 82
c - update scripts to allow installation of lmbench into system
c   directories
cC
cK53253
e
s 00006/00002/00411
d D 1.81 02/11/12 09:47:10 staelin 82 81
c src/Makefile: Add new lat_rand
cC
cK40699
e
s 00005/00002/00408
d D 1.80 02/11/08 09:16:14 staelin 81 80
c src/Makefile: add a new benchmark, lat_pmake, which measures the
c   time to start and complete N jobs which each do a fixed amount
c   of work.  To some extent this measures an SMP scheduler.
cC
cK29497
e
s 00001/00001/00409
...
ASMS =  $O/bw_file_rd.s $O/bw_mem.s $O/bw_mmap_rd.s $O/bw_pipe.s 	\
	$O/bw_tcp.s $O/bw_udp.s $O/bw_unix.s $O/cache.s $O/clock.s	\
	...
	$O/lat_usleep.s $O/lat_pmake.s $O/lib_debug.s $O/lib_mem.s	\
	$O/lib_stats.s $O/lib_tcp.s $O/lib_timing.s $O/lib_udp.s	\
	$O/lib_unix.s $O/line.s $O/lmdd.s $O/lmhttp.s $O/par_mem.s	\
...
E 83
I 83
	cd ../doc; env MAKEFLAGS="$(MAKEFLAGS)" make BASE="$(BASE)" install
E 83
...
I 84
assembler:
	@env CFLAGS=-O MAKE="$(MAKE)" MAKEFLAGS="$(MAKEFLAGS)" ../scripts/build asm
